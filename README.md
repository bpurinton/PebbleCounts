...
## Note on imagery and running PebbleCounts
Georeferenced ortho-photos should be in a **UTM projection**, providing the scale in meters. Because PebbleCounts doesn't allow you to save work in the middle of clicking it's recommended that you don't use images covering areas of more than 2 by 2 meters or so. Furthermore, the algorithm is most effective on images of 0.8-1.2 mm/pixel resolution. For higher resolution (sub-mm) imagery it's recommended not to go above 1 by 1 meter areas, particularly if there are many < 1 cm pebbles. If you want to cover a larger area simply break the image into smaller parts and process each individually, so you can give yourself a break. Head-over to the [full manual](docs/PebbleCounts_Manual.pdf) for a step-by-step guide to running PebbleCounts for a given image.
